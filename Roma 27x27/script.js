...
const pieceConfig = {
    'king_w': { color: 'white', src: 'pieces/Centurion_stab.gif' },
  
    'pawn_w': { color: 'white', src: 'pieces/Centurion_stab_Return_of_Rome.gif' },

    'king_b': { color: 'black', src: 'pieces/Grozmeister_Ulrich.gif' },
   
    'pawn_b': { color: 'black', src: 'pieces/Magyar_Huszar_rearing.gif' }
};
