...
const pieceConfig = {
    'king_w': { color: 'white', src: 'pieces/skul.gif' },
        'pawn_w': { color: 'white', src: 'pieces/tombskul.gif' },

    'king_b': { color: 'black', src: 'pieces/genio.gif' },
    
    'pawn_b': { color: 'black', src: 'pieces/webmail.gif' }
};
